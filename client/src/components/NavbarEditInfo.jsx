                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label  className="editlabel" for="materialFormRegisterNameEx">First Name</label>
                                    </div>
                                ...
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="materialFormRegisterNameEx">Last Name</label>
                                    </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="materialFormRegisterNameEx">Age</label>
                                    </div>
                                ...
                                <div className="col-md-4">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="materialFormRegisterNameEx">Sex</label>
                                    </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="materialFormRegisterEmailEx">Your email</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="materialFormRegisterNameEx">Phone Number</label>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="textareaPrefix">Medical History</label>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="textareaPrefix">Current Medications</label>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="textareaPrefix">Allergies</label>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="inputMDEx">Physician's Name</label>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="inputMDEx">Hospital of choice</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="inputMDEx">First/Last Name</label>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="md-form">
                                        ...
                                        <label className="editlabel" for="inputMDEx">Phone Number</label>
                                    </div>
                                </div>
                            </div>
