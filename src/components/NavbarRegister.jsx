                            ...
                            <Container className="animated slideInRight">
                                <Card>
                                    <CardBody>
                                        ...
                                        <Input label="Example label" hint="First name" />

                                        <Input label="Example label" hint="Last name" />


                                        <Input label="Example label" icon="envelope" hint="email" />

                                        <Input label="Example label" icon="phone" hint="000-000-0000" />


                                        <Input label="Example label" icon="envelope" />

                                        <CardText>Medical Information</CardText>
